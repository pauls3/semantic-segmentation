...
__C.DATASET.CITYSCAPES_CUSTOMCOARSE = \
  os.path.join(__C.ASSETS_PATH, 'rtis_lab/data/Cityscapes/autolabelled')
__C.DATASET.CENTROID_ROOT = \
  os.path.join(__C.ASSETS_PATH, 'repos/nvidia_hrnet-ocr/uniform_centroids')
...
WEIGHTS_PATH = os.path.join(__C.ASSETS_PATH, 'rtis_lab/data/Cityscapes/large_asset_dir/seg_weights')
